...
local function set_fold_hl()
  local nf = vim.api.nvim_get_hl(0, { name = "FoldedIcon", link = false })
  local comment = vim.api.nvim_get_hl(0, { name = "String", link = false })
  vim.api.nvim_set_hl(0, "FoldedIcon", { fg = comment.fg })
  vim.api.nvim_set_hl(0, "FoldedText", { bg = comment.bg, fg = comment.fg, italic = true })
end
